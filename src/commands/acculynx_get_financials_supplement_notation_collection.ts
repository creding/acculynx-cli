...
export default defineAcculynxTool({
  description: "Get all the notations for a specific supplement.",
  ...
  async call(client, { supplementId, pageSize, recordStartIndex }) {
    const res = await client.getFinancialsSupplementNotationCollection({ supplementId, pageSize, recordStartIndex });
    return res.data;
  },
});
