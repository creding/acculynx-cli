...
export default defineAcculynxTool({
  description: "Get Company Countries",
  ...
  async call(client, { includes, pageSize, recordStartIndex }) {
    const res = await client.getCompanySettingsLocationSettingsCountries({ includes, pageSize, recordStartIndex });
    return res.data;
  },
});
