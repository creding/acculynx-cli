...
const PaidPayment = {
  ...
  "properties": {
    ...
    "notes": {
      ...
      "examples": [
        "Payment for labor and materials per contract"
      ]
    },
    "paymentDate": {
      "type": "string",
      "format": "date-time",
      "description": "The date the payment was made. The time component is always midnight UTC (e.g. 2022-06-22T00:00:00Z).",
      "examples": [
