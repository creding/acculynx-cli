import JobInsuranceCompanyPut from './JobInsuranceCompanyPut.js';

const JobInsurancePut = {
  "title": "jobInsurancePut",
  "x-readme-ref-name": "jobInsurancePut",
  "type": "object",
  "properties": {
    "insuranceCompany": JobInsuranceCompanyPut,
...
export default JobInsurancePut
